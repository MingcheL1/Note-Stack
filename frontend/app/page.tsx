...
export default function Home() {
  const notes = [
    {
      quote:
        "Polynomials: An expression with multiple terms containing the same variable with different powers.",
      name: "Yuna",
      title: "Polynomials Notes",
    },
    {
      quote:
        "Kinematics: The Study of Motion Definition: The branch of classical mechanics describing motion without considering its causes (forces).",
      name: "George",
      title: "Physics Notes",
    },
    {
...
1
  return (
    <div className="bg-black min-h-screen">
      ...
      {/* Hero Section */}
      <div className="h-[40rem] bg-black flex flex-col items-center justify-center overflow-hidden rounded-md mt-5 relative">
        ...
        <MacbookScroll
          title={
            <span className="text-white">
              Upload Lesson Recordings and Text <br /> Get instant notes from AI
            </span>
          }
          badge={
